...
FORBIDDEN_INCLUDES = [
    ...
    ("Base/Log.h", []), 
    ("Base/format.h", []),
    ("algorithm", ["Swiften/Base/Algorithm.h", "Swiften/Base/SafeAllocator.h", "Swiften/Base/Listenable.h", "Swiften/Base/Concat.h", "Swiften/Elements/MIXJoin.h", "Swiften/Elements/MIXUpdateSubscription.h", "Swiften/MIX/MIX.h"]), 
    ("boost/bind.hpp", ["Swiften/Base/Listenable.h", "Swiften/FileTransfer/S5BTransportSession.h", "Swiften/MIX/MIX.h"]), 
