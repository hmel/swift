...
public:
  ...
  void testRequestVCard_ReturnItemNotFoundError() {
    auto testling = createManager();
    testling->requestVCard(JID("foo@bar.com/baz"));
    stanzaChannel->onIQReceived([&]() { return IQ::createError(JID("foo@bar.com/baz"), stanzaChannel->sentStanzas[0]->getTo(), stanzaChannel->sentStanzas[0]->getID(), ErrorPayload::ItemNotFound); }());
  ...
  void testRequestVCard_ReturnFeatureNotImplementedError() {
    auto testling = createManager();
    testling->requestVCard(JID("foo@bar.com/baz"));
    stanzaChannel->onIQReceived([&]() { return IQ::createError(JID("foo@bar.com/baz"), stanzaChannel->sentStanzas[0]->getTo(), stanzaChannel->sentStanzas[0]->getID(), ErrorPayload::FeatureNotImplemented); }());
  ...
  void testRequestOwnVCard_ReturnItemNotFoundError() {
    auto testling = createManager();
    testling->requestVCard(ownJID);
    stanzaChannel->onIQReceived([&]() { return IQ::createError(JID(), stanzaChannel->sentStanzas[0]->getTo(), stanzaChannel->sentStanzas[0]->getID(), ErrorPayload::ItemNotFound); }());
  ...
  void testRequestOwnVCard_ReturnFeatureNotImplementedError() {
    auto testling = createManager();
    testling->requestVCard(ownJID);
    stanzaChannel->onIQReceived([&]() { return IQ::createError(JID(), stanzaChannel->sentStanzas[0]->getTo(), stanzaChannel->sentStanzas[0]->getID(), ErrorPayload::FeatureNotImplemented); }());
