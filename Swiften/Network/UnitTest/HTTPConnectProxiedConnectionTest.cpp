...
public:
  ...
  void testTrafficFilter() {
    ...
    connectionFactory->connections[0]->onDataRead(createSafeByteArrayRef("HTTP/1.0 401 Unauthorized\r\n"));
    eventLoop->processEvents();
    connectionFactory->connections[0]->onDataRead(createSafeByteArrayRef("WWW-Authenticate: Negotiate\r\n"
                                                                         "\r\n"));
    eventLoop->processEvents();
  ...
  void testTrafficFilterNoConnectionReuse() {
    ...
    connectionFactory->connections[0]->onDataRead(createSafeByteArrayRef("HTTP/1.0 407 ProxyAuthentication Required\r\n"
    ...
    connectionFactory->connections[1]->onDataRead(createSafeByteArrayRef("HTTP/1.0 407 ProxyAuthentication Required\r\n"
    ...
    connectionFactory->connections[2]->onDataRead(createSafeByteArrayRef("HTTP/1.0 200 OK\r\n"
                                                                         "\r\n"));
    eventLoop->processEvents();
